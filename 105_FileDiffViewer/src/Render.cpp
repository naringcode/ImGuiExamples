...
void WidgetWindow::drawDiffView()
{
...
void WidgetWindow::drawStatistics()
{
...
WidgetWindow::FileContents WidgetWindow::loadFileContents(const std::string_view& filePath)
{
...
void WidgetWindow::saveFileContents(const std::string_view& filePath, const FileContents& fileContents)
{
