...
void PaintWindow::Draw(const std::string& windowName, bool* open)
{
...
void PaintWindow::drawSizeSettings()
{
...
void PaintWindow::drawSavePopup()
{
...
void PaintWindow::drawLoadPopup()
{
    const bool kEscPressed = ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Escape));
...
void PaintWindow::saveToImageFile(std::string_view filename)
{
    // 파일 열기
...
void PaintWindow::loadFromImageFile(std::string_view filename)
{
    // 파일 읽기
