...
void PlotterWindow::Draw(const std::string& windowName, bool* open)
{
...
void PlotterWindow::drawSelection()
{
...
PlotterWindow::Function PlotterWindow::functionNameMapping(std::string_view functionName)
{
    if ("sin(x)" == functionName)
        return PlotterWindow::Function::kSin;

    if ("cos(x)" == functionName)
        return PlotterWindow::Function::kCos;

    return PlotterWindow::Function::kNone;
}

double PlotterWindow::evaluateFunction(const Function function, const double x)
{
    switch (function)
    {
        case Function::kSin:
