...
void CsvEditorWindow::Draw(const std::string& windowName, bool* open)
{
...
void CsvEditorWindow::drawSizeButtons()
{
...
void CsvEditorWindow::drawIoButtons()
{
...
void CsvEditorWindow::drawTable()
{
...
void CsvEditorWindow::drawSavePopup()
{
...
void CsvEditorWindow::drawLoadPopup()
{
    const bool kEscPressed = ImGui::IsKeyPressed(ImGui::GetKeyIndex(ImGuiKey_Escape));
...
void CsvEditorWindow::drawValuePopup(const int kRow, const int kCol)
{
...
void CsvEditorWindow::saveToCsvFile(const std::string_view& filename)
{
...
void CsvEditorWindow::loadFromCsvFile(const std::string_view& filename)
{
...
template <typename T>
void CsvEditorWindow::PlotCellValue(std::string_view formatter, const T value)
{
...
void CsvEditorWindow::SetPopupLayout()
{
