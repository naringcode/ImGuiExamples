...
void TextEditorWindow::Draw(const std::string& windowName, bool* open)
{
...
void TextEditorWindow::drawMenu()
{
...
void TextEditorWindow::drawSavePopup()
{
...
void TextEditorWindow::drawLoadPopup()
{
...
void TextEditorWindow::drawContents()
{
...
void TextEditorWindow::drawInfo()
{
...
void TextEditorWindow::saveToFile(const std::string_view& filename)
{
    // 파일 열기
...
void TextEditorWindow::loadFromFile(const std::string_view& filename)
{
    // 파일 읽기
...
std::string TextEditorWindow::getFileExtension(const std::string_view& filename)
{
