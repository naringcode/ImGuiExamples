...
void WidgetWindow::drawDataCombo()
{
...
void WidgetWindow::drawCalendar()
{
...
void WidgetWindow::drawAddMeetingWindow()
{
...
void WidgetWindow::drawMeetingList()
{
...
void WidgetWindow::loadMeetingsFromFile(const std::string_view& filename)
{
    // 파일 읽기
...
void WidgetWindow::saveMeetingsToFile(const std::string_view& filename)
{
    // 파일 열기
...
void WidgetWindow::updateSelectedDateVariables()
{
...
void WidgetWindow::Meeting::Serialize(std::ofstream& out) const
{
...
WidgetWindow::Meeting WidgetWindow::Meeting::Deserialize(std::ifstream& in)
{
